...
public class Character4 extends Character {
    ...
    @Override
    public void useAbility(Character... targets) {
        if (health <= 0) {
    ...
    public void shoot(Character target) {
        ...
        if (!isReady){
            ...
            for (Character abilityTargetCharacter : abilityTargetCharacters) {
